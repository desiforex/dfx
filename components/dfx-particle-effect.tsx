...
export default function DFXParticleEffect() {
  ...
  useEffect(() => {
    ...
    function createTextImage() {
      ...
      // Draw DFX text
      ctx.font = `bold ${logoHeight * 0.4}px 'Geist', monospace`
      ctx.textAlign = "center"
      ctx.fillText("DFX", logoWidth / 2, logoHeight * 0.6)

      ctx.font = `${logoHeight * 0.15}px 'Geist', monospace`
      ctx.fillText("DESIFOREX", logoWidth / 2, logoHeight * 0.85)
  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-center justify-center bg-black">
      <canvas
        ...
        aria-label="Interactive DFX particle effect"
      />
